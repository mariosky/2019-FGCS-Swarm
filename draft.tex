...
file received by workers in  Listing \ref{code:config}. % Adding to Annex or is not even needed? - M
...
The format of the JSON message is depicted in  Listing \ref{code:result}. % Adding to Annex or is not even needed? - M
