...
\begin{figure}[ht]
    ...
    \caption{Population State and dataflow between processing nodes of the EvoSpace algorithm.} % Er, same caption. Better insert it now, or we might roftet... Also, same label. - JJ
    % Ok, it was a "temporal" Copy-Paste solution - Mario
