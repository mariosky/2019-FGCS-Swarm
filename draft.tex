...
Researchers and algorithm designers willing to  adapt to the cloud their
multi-population solutions face the following challenges:
\begin{itemize}
...
orchestration and deployment technologies if more scalabilty like Docker Swarm
and Kubernetes with additional configuration.  
Docker Container images host the stateless functions responsible for running algorithms
on subpopulations(these can be used directly in a FaaS implementation).
