...
the experiments queue, this is not shown in the diagram. The configuration message 
...
\begin{enumerate}
\item In this step, the specified number of subpopulations is created according to the 
...
and subpopulations are separated, and the Population Queue keeps the state
