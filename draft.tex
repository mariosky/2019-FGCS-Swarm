...
In the case of the first level of integration, developers % a decoupler worker what? - JJ
% I think it was redundant, I was saying that in this level the worker container
% is not tied to the rest of the containers. - M 
...
%Also, if they can use the existing implementation, you need to specify the license - JJ
...
population provided as a parameter. Depending on the library used, % Depending on which library? - JJ 
it may be required to extract the population from the
JSON message and replace the population object created by the library. For
