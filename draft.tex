...
% I forgot to put done, but I added in the above paragraphs. It was correct? - Mario
...
container %maybe you should specify more, at the beginning of the section, 
% what is the current setup, what containers are there, what libraries are being used, and so on. - JJ
% The previous section talks about, can you have look? Maybe I should move it to this one. - Mario
% If not, I will add a remainder, something like: following from the setup described in the previous section... - M  
to specify additional configuration options. For instance,  % related to? What do you mean here? - done Mario 
...
% Clarify what you need to change in those images. 
% Added a brief comment at the beginning  - M
% Will you need to 
% just rebuild the image with new code, or something else? - JJ
% That and document your work, talk about this at the end - M
% We need to document our own images :) - M   
...
% Besides addressing the concerns of a reviewer, you should mention how this is 
% related to the overall objective of the paper, saying this contributes to
% reproducibility or to be able to do it on the cloud  - Jj
% Added the lines bellow - Mario
