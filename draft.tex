...
% reactive is mentioned here for the first time. Possibly you should just refer to "cloud-native" and then specify that it implies asynchrony, reactivity, and so on - JJ
% OK - Mario
In this
...
proposed asynchronous algorithms, reporting benefits in execution time, and
scalability. In these works, sub-populations
are processed independently and communicate asynchronously through a central
repository or message queue [refs needed to our previous work].
