...
\begin{table}[]
  ...
  \vspace{0.25cm}
    ...
    \hline
          2   & 1w      & \textbf{2.96}   & 3.15   \\
              & 2w      & 1.84   & \textbf{1.72}   \\
              & 4w      & 1.22   & \textbf{0.96}   \\
              & 8w      & 1.05   & \textbf{0.59}   \\
    \hline
          3   & 1w      & \textbf{6.53}   & 7.76   \\
              & 2w      & 3.64   & 3.83   \\
              & 4w      & 2.33   & 2.26   \\
              & 8w      & 2.17   & \textbf{1.36}   \\
    \hline
...
required for the execution of an instance (shown in boldface), mainly when using the same parameters
...
we can perform with the EvoSwarm application by reusing the COCO framework.
...
a Fargate configuration. 
                                  % Please use caps or not for Tasks in a consistent way - JJ
                                  % Done -Mario
                                  % Done above - M
