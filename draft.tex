...
populations might enhance evolutionary search and need less
evaluations than homogeneous systems; heterogeneous settings, if
done right, will increase the diversity of the whole population % cita
                                % multikulti o similar - JJ

% Explain that heterogeneity comes from using different algorithms,
% not from using different types of nodes - JJ
But this is a rule of thumb, and it will depend on the degree of
heterogeneity, as well as on the algorithm itself. In this experiment, we compare the performance of both heterogeneous and
...
functions of the BBOB testbed.  We used ten populations and 8 workers for the
