...
event-based, cloud-native architecture suitable for hosting multi-population
optimization algorithms. The framework is based in industry-standard development
tools such as Docker and Docker Compose, making it easy to develop and deploy
...
four other proposals for multi-population algorithms found in the literature. We
found that it is best suited for asynchronous multi-population algorithms.
...
populations near-equal to the number of workers, which brings performance gains.
...
Optimization (PSO) using the COCO benchmark framework for continuous functions.
