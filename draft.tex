...
% Anyway you need to say what is the signature of the function. 
% Also, if they can use the existing implementation, you need to specify the license - JJ u
% Any reaction to this? - JJ
...
container %maybe you should specify more, at the beginning of the section, what is the current setup, what containers are there, what libraries are being used, and so no. - JJ 
to specify additional configuration options. For instance,  % related to? What do you mean here?
...
can apply these rules selectively only to swarm-based algorithms. In general, these configuration options will be algorithm and library specific. 

On either level of integration, algorithm developers can upload the container
definition or images directly to a public repository like DockerHub. % Clarify what you need to change in those images. Will you need to just rebuild the image with new code, or something else? - JJ
Another
...
% Besides addressing the concerns of a reviewer, you should mention how this is related to the overall objective of the paper, saying this contributes to reproducibility or to be able to do it on the cloud  - Jj
...
%
% Boxplot of the total number of evaluations for 30 instances of function f4 , with
% different number of workers and populations sizes
