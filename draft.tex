...
Besides being, all of them, population-based, they also share the common characteristic of
...
prototyping while having the option of deployment to services provided
by a cloud provider, thus using modern methodologies and technologies.
...
of the method, concerning scalability and % This is a subsection, fix it. 
...
current state of the population and data about the problem, algorithm, and parameters. 
