...
of individuals takes more time from the beginning to reach to all of them.
...
all cases, and even with a single worker, populations are heterogeneous, 
 individuals resulting from the mixing of populations take more time to propagate. 
