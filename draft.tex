...
algorithms. % If you want to prove it *improves*, you need to provide a baseline. What will be your baseline? You need to specify anyway in which way it really improves - JJ
...
% that's pretty obvious. Say what you intend to prove with the experiments and why - JJ 
% Removed - M
% The effect of a
...
% You should start writing this out soon... Don't leave it this way - JJ
Several options:
