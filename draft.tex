...
Container-based applications describe the deployment of loosely coupled processes in a
consistent and portable way, in every phase of the life cycle of an application, from development through testing to production
...
a cloud-native application to a cloud provider, we have some more options to choose:
...
by the {\texttt compose command} that uses a {\texttt docker-compose.yml} file to generate 
...
and scale the number of worker tasks to eight.  % Please use caps or not for Tasks in a consistent way - JJ
