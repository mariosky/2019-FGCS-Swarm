...
\begin{frontmatter}
  ...
  % I like cloud-native more than event-based. 
  % How about that one?  - M
...
\begin{table}[h!tbp]
  ...
  20  & Local       & \textbf{36,101.86}   \\
      & Multi task  & {\ul 33,916.02}       \\ % why the underline? [Best between cloud options :) - Mario]
...
and resources to an orchestration service? % This does not fit in
                                % here... It's related to
                                % reproducibility, and as such belongs
                                % in the previous section. The
                                % subsections that answer this should
                                % also go to the previous section - JJ
% Still need to check this out - JJ
\end{itemize}
...
% Almost everything, but the cream-colored rhombs in the bottom...
}
\label{fig:bbob}
\end{figure*}
