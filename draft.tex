...
% Maybe you should say here how everything works: launch with
...
% You said "subsections will talk about roles", this is not a role. 
% Change the title to that of a role. Would that be administrator? - JJ

\subsection{EvoSwarm from the User Point of View} 
% All in a single section - Mario
%\subsubsection{Experiment Configuration and Execution}
...
\begin{table}[h!tbp]
  ...
  20  & Local       & \textbf{36,101.86}   \\
      & Multi task  & {\ul 33,916.02}       \\ % why the underline? [Best between cloud options :) - Mario] Then why not above too? - JJ
