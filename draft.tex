...
% TODO: connection to cloud subsection  - M
% Done - M 
...
% Write some introduction to this subsubsection.
% Done - M
...
% Emphasize these results for the purpose of the paper - JJ
% done - Mario
...
% You should clarify that, before, you were explaining how to set up
% an experiment. In this section, you are explaining the experiments
% that you are doing in this paper. But you should relate both
% sections to the general objectives of the paper. In the prior
% section, you want to prove that EvoSwarm can be used by the public
% to create reproductive research (and maybe you should add a small
% conclusion sub or sub-sub section), in the next you explain the
% experiment we are doing for this paper. It would be interesting to
% make references from the next section to the previous one,
% indicating how the general setup of EvoSwarm helps _us_ to create
% this experiment - JJ  
% Connected below - M  
...
% Also, point forward to the section (or subsections) that will be devoted to proving each point.
% BTW, they should probably be subsections.
% Done - M
...
% Done, I added the research question at the beginning of the setup question - M
...
To answer the first research question, we need to evaluate the effect of these parameters on the scalability of the system,   we
...
will be one worker, and the minimum amount of work available will be five
populations. Five populations are selected because the controller needs at least
...
fewer workers is a better option (see values underlined in the table) with the best  
for 40 dimensions (in bold). The worst speed was going from four to eight workers 
at higher dimensions (underlined in the table). For ten populations, overall 
has the linear speedup but the best is from four to eight workers at 40 dimensions
(shown in bold).
