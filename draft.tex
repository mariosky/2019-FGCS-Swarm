...
within this paper. Running the cloud-native application in the cloud has the
...
\begin{description}
  ...
  provisioning. All major cloud-providers have Kubernetes services. This option
