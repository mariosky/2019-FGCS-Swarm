...
\section{Reproducible Experimental Workflow in EvoSwarm} 
...
\begin{itemize}
  % Question move to here for the moment, at least we need to mention this in this intro.
...
% This is one of the applications described in the Workflow Figure. But this is better explained in other places.
% We can delete it (even from the Figure)  
% Will leave it until we decide - M 
...
(from deploying it locally using {\tt docker-compose}) and it is has a lower cost than the Kubernetes alternative. % Remember to mention cost at the end - JJ
...
\label{sec:general-setup} % To be renamed 
